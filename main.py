...
API_ID = 7452174
API_HASH = 'd269d703118fbf6007c7c5b98073aff2'
 
PRIVATE_PUBLIC = 'grabbs_sm_bot'  # скрытый паблик для управления ботом
PUBLIC_PUBLIC = 'shokmash'  # паблик куда будем репостить
SOURCE_PUBLICS = [
...
PHONE_NUMBER = '+79227778077'  # номер зарегистрованный в телеге
